...
using Barcode.Generator.Aztec;
using Barcode.Generator.Common;
using Barcode.Generator.Datamatrix;
using Barcode.Generator.OneD;
using Barcode.Generator.PDF417;
using Barcode.Generator.QrCode;
